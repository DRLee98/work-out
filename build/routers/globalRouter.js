...
globalRouter.post(_routes["default"].join, _middlewares.onlyPublic, _upload.upload.single("profile"), _userController.postJoin, _userController.postLogin);
...
globalRouter.get(_routes["default"].calendar, _globalController.getCalendar);
