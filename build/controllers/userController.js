...
var postAddCompleteDate = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(req, res) {
    var id, user, dateList, _dateList$map, _dateList$map2, year, month, date, completeDate, existDate;
    ...
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 4:
            user = _context6.sent;
            dateList = new Date().toLocaleDateString().split("-");
            _dateList$map = dateList.map(function (item) {
              return parseInt(item);
            }), _dateList$map2 = _slicedToArray(_dateList$map, 3), year = _dateList$map2[0], month = _dateList$map2[1], date = _dateList$map2[2];
            completeDate = {
              year: year,
              month: month,
              date: date
